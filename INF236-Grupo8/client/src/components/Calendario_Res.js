...
export default class Calendario_Res extends React.Component {
        ...
        <div className="container-fluid">
          <div className='row align-items-start p-2'>
            <div className="btn-group btn-group-toggle col-md-4" data-toggle="buttons">
              <Link className="btn btn-secondary active col-md-1" to={"/Calendario/Resonancia/"+anoActual+"_"+mes} role="button">Resonancia</Link>
            ...
            <div className='text-center col-md-6'><h4>Calendario de {mesActual} de Resonancia {anoActual}</h4></div>
                ...
                <div className='container-fluid'>
                  <div className='row align-items-start'>
                    <button type="button" className="col btn btn-outline-success btn-lg m-2">
                        <h5><Link className="nav-link" to={'/Calendario/Crear/'+anoActual+'_'+mes+'_'+dia+'_08:30_Res'}>08:30</Link></h5>
                    </button>
                    <button type="button" className="col btn btn-outline-success btn-lg m-2">
                        <h5><Link className="nav-link" to={'/Calendario/Crear/'+anoActual+'_'+mes+'_'+dia+'_10:00_Res'}>10:00</Link></h5>
                    </button>
                    <button type="button" className="col btn btn-outline-success btn-lg m-2">
                        <h5><Link className="nav-link" to={'/Calendario/Crear/'+anoActual+'_'+mes+'_'+dia+'_11:30_Res'}>11:30</Link></h5>
                    </button>
                    <button type="button" className="col btn btn-outline-success btn-lg m-2">
                        <h5><Link className="nav-link" to={'/Calendario/Crear/'+anoActual+'_'+mes+'_'+dia+'_14:00_Res'}>14:00</Link></h5>
                    </button>
                    <button type="button" className="col btn btn-outline-success btn-lg m-2" >
                        <h5><Link className="nav-link" to={'/Calendario/Crear/'+anoActual+'_'+mes+'_'+dia+'_15:30_Res'}>15:30</Link></h5>
                    </button>
                  </div>
                </div>
              </div>
