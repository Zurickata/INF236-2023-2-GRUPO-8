        ...
        <div class="container-fluid">
          <div className='row align-items-start p-2'>
            <div class="btn-group btn-group-toggle col-md-4" data-toggle="buttons">
              <Link className="btn btn-secondary active col-md-1" to='/Calendario/Resonancia' role="button">Resonancia</Link>
              ...
              <Link className="btn btn-secondary col-md-1" to='/Calendario/Ecografia' role="button">Ecografía</Link>
            </div>
            <Link className="btn btn-primary col-md-1" to='/Calendario' role="button">Mes anterior</Link>
            <p className='text-center col-md-6'><h4>Calendario de {mesActual} de Resonancia {anoActual}</h4></p>
              ...
              <div className='card cardbody col m-2'>
                <div className='container-fluid'>
                  <div className='row align-items-start'>
                    ...
                    <button type="button" className="col btn btn-outline-success btn-lg m-2">
                        <h5><Link className="nav-link" to='/Calendario/Crear'>14:00</Link></h5>
                    </button>
                    <button type="button" className="col btn btn-outline-success btn-lg m-2" >
                        <h5><Link className="nav-link" to='/Calendario/Crear'>15:30</Link></h5>
                    </button>
                  </div>
                </div>
              </div>
